...
const user_roles_model_1 = require("../../users/schemas/user-roles.model");
...
__decorate([
    swagger_1.ApiProperty({ example: 'USER', description: 'Role name' }),
...
__decorate([
    swagger_1.ApiProperty({ example: 'Role owned by all users' }),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: false }),
    __metadata("design:type", String)
], Role.prototype, "description", void 0);
__decorate([
    sequelize_typescript_1.BelongsToMany(() => user_model_1.User, () => user_roles_model_1.UserRoles),
