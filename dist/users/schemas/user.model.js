...
__decorate([
    swagger_1.ApiProperty({ example: '1337', description: 'Unique id' }),
...
__decorate([
    swagger_1.ApiProperty({ example: 'user@example.com', description: 'User\'s email' }),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, unique: true, allowNull: false }),
    __metadata("design:type", String)
], User.prototype, "email", void 0);
__decorate([
    swagger_1.ApiProperty({ example: 'example123', description: 'User\'s password' }),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: false }),
    __metadata("design:type", String)
], User.prototype, "password", void 0);
__decorate([
    swagger_1.ApiProperty({ example: 'true', description: 'Is user banned or no' }),
...
__decorate([
    swagger_1.ApiProperty({ example: 'Spam', description: 'User\'s ban reason' }),
